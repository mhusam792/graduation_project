# -*- coding: utf-8 -*-
"""text to image genarate.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1v-UYgvlSUP-Y4zZozc2Ut9H4AJAjs_jV
"""
...
# t=trans("قطة سوداء سيامي لها عينان زرقوان")
# print(t)

parent_folder_path = "/content/genarated_images"
...
def create_img(method:str,text:str,img_number: int = 6):
  ...
  if method=="AI":
    ...
    for result in imagine(prompts):
      result.img.save(f"/content/genarated_images/{descrption}.png")
  if method=="google".upper():
    respone=simp.simple_image_download
    keyword=descrption
    respone().download(keyword,img_number+5)
    img_path=glob.glob(os.path.join(f'/content/simple_images/{keyword}',"*.*"))
    images=[]
    not_good=[]
    not_good.append(cv2.cvtColor(cv2.imread("/content/drive/MyDrive/ColabNotebooks/not_good_images/notgood3.png"),cv2.COLOR_BGR2RGB))
    not_good.append(cv2.cvtColor(cv2.imread("/content/drive/MyDrive/ColabNotebooks/not_good_images/notgood2.png"),cv2.COLOR_BGR2RGB))
    not_good.append(cv2.cvtColor(cv2.imread("/content/drive/MyDrive/ColabNotebooks/not_good_images/notgood1.png"),cv2.COLOR_BGR2RGB))
    not_good.append(cv2.cvtColor(cv2.imread("/content/drive/MyDrive/ColabNotebooks/not_good_images/notgood.jpeg"),cv2.COLOR_BGR2RGB))
...
# create_img("google".upper(),"قطة سوداء")#/content/simple_images/Siamese black cat with two blue eyes